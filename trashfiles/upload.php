...
if(isset ($_FILES ['video'])){
	...
	if (!empty ($title) || ($desc)|| ($keywords) || ($privacy) || ($field)) {
	...
	if (file_exists ('Assets/Vids/mp4/' .$random_directory.''. $_FILES['video']['name'])){
		echo 'video excists';
		}else {
			...
			'$user', '$privacy','$field','$date',0,'$video_id', '','$filename')");
...
Field:
<input type ='radio' name = 'field ' value = 'IT'/> IT&nbsp; &nbsp;
